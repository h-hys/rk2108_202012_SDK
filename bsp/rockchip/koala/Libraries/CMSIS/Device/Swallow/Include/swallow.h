...
/* BUFFER_MANAGE Register Structure Define */
struct BUFFER_MANAGE_REG {
    __IO uint32_t WCH_MBLK0_CON0;                    /* Address Offset: 0x0000 */
    __IO uint32_t WCH_MBLK0_CON1;                    /* Address Offset: 0x0004 */
    __IO uint32_t WCH_MBLK0_CON2;                    /* Address Offset: 0x0008 */
    __IO uint32_t WCH_MBLK0_CON3;                    /* Address Offset: 0x000C */
    __IO uint32_t WCH_MBLK0_CON4;                    /* Address Offset: 0x0010 */
    __IO uint32_t WCH_MBLK0_CON5;                    /* Address Offset: 0x0014 */
    __IO uint32_t WCH_MBLK0_CON6;                    /* Address Offset: 0x0018 */
         uint32_t RESERVED001C;                       /* Address Offset: 0x001C */
    __IO uint32_t WCH_MBLK0_STATUS0;                 /* Address Offset: 0x0020 */
    __IO uint32_t WCH_MBLK0_STATUS1;                 /* Address Offset: 0x0024 */
    __IO uint32_t WCH_MBLK0_STATUS2;                 /* Address Offset: 0x0028 */
    __IO uint32_t WCH_MBLK0_STATUS3;                 /* Address Offset: 0x002C */
    __IO uint32_t WCH_MBLK0_INT_EN;                  /* Address Offset: 0x0030 */
    __IO uint32_t WCH_MBLK0_INTSTS;                  /* Address Offset: 0x0034 */
         uint32_t RESERVED0038[114];                  /* Address Offset: 0x0038 */
    __IO uint32_t RCH_MBLK0_CON0;                    /* Address Offset: 0x0200 */
    __IO uint32_t RCH_MBLK0_CON1;                    /* Address Offset: 0x0204 */
    __IO uint32_t RCH_MBLK0_CON2;                    /* Address Offset: 0x0208 */
         uint32_t RESERVED020C[3];                    /* Address Offset: 0x020C */
    __IO uint32_t RCH_MBLK0_CON6;                    /* Address Offset: 0x0218 */
         uint32_t RESERVED021C;                       /* Address Offset: 0x021C */
    __IO uint32_t RCH_MBLK0_STATUS0;                 /* Address Offset: 0x0220 */
         uint32_t RESERVED0224;                       /* Address Offset: 0x0224 */
    __IO uint32_t RCH_MBLK0_STATUS2;                 /* Address Offset: 0x0228 */
    __IO uint32_t RCH_MBLK0_STATUS3;                 /* Address Offset: 0x022C */
    __IO uint32_t RCH_MBLK0_INT_EN;                  /* Address Offset: 0x0230 */
    __IO uint32_t RCH_MBLK0_INTSTS;                  /* Address Offset: 0x0234 */
};
...
/*************************************BUFFER_MANAGE**************************************/
/* WCH_MBLK_CON0 */
#define BUFFER_MANAGE_WCH_MBLK_CON0_OFFSET               (0x0U)
#define BUFFER_MANAGE_WCH_MBLK_CON0_PPBUF_ENABLE_SHIFT   (0U)
#define BUFFER_MANAGE_WCH_MBLK_CON0_PPBUF_ENABLE_MASK    (0x1U << BUFFER_MANAGE_WCH_MBLK_CON0_PPBUF_ENABLE_SHIFT)   /* 0x00000001 */
#define BUFFER_MANAGE_WCH_MBLK_CON0_PPBUF0_FULL_HARDCLR_EN_SHIFT (1U)
#define BUFFER_MANAGE_WCH_MBLK_CON0_PPBUF0_FULL_HARDCLR_EN_MASK (0x1U << BUFFER_MANAGE_WCH_MBLK_CON0_PPBUF0_FULL_HARDCLR_EN_SHIFT) /* 0x00000002 */
#define BUFFER_MANAGE_WCH_MBLK_CON0_PPBUF1_FULL_HARDCLR_EN_SHIFT (2U)
#define BUFFER_MANAGE_WCH_MBLK_CON0_PPBUF1_FULL_HARDCLR_EN_MASK (0x1U << BUFFER_MANAGE_WCH_MBLK_CON0_PPBUF1_FULL_HARDCLR_EN_SHIFT) /* 0x00000004 */
#define BUFFER_MANAGE_WCH_MBLK_CON0_PPBUF_SIZE_SHIFT     (4U)
#define BUFFER_MANAGE_WCH_MBLK_CON0_PPBUF_SIZE_MASK      (0x1FFFFU << BUFFER_MANAGE_WCH_MBLK_CON0_PPBUF_SIZE_SHIFT) /* 0x001FFFF0 */
#define BUFFER_MANAGE_WCH_MBLK_CON0_PPBUF_NUM_SHIFT      (24U)
#define BUFFER_MANAGE_WCH_MBLK_CON0_PPBUF_NUM_MASK       (0x7U << BUFFER_MANAGE_WCH_MBLK_CON0_PPBUF_NUM_SHIFT)      /* 0x07000000 */
#define BUFFER_MANAGE_WCH_MBLK_CON0_ADDR_HIGHBIT_SHIFT   (28U)
#define BUFFER_MANAGE_WCH_MBLK_CON0_ADDR_HIGHBIT_MASK    (0xFU << BUFFER_MANAGE_WCH_MBLK_CON0_ADDR_HIGHBIT_SHIFT)   /* 0xF0000000 */
/* WCH_MBLK_CON1 */
#define BUFFER_MANAGE_WCH_MBLK_CON1_OFFSET               (0x4U)
#define BUFFER_MANAGE_WCH_MBLK_CON1_PPBUF0_START_ADDR_SHIFT (0U)
#define BUFFER_MANAGE_WCH_MBLK_CON1_PPBUF0_START_ADDR_MASK (0xFFFFFFFFU << BUFFER_MANAGE_WCH_MBLK_CON1_PPBUF0_START_ADDR_SHIFT) /* 0xFFFFFFFF */
/* WCH_MBLK_CON2 */
#define BUFFER_MANAGE_WCH_MBLK_CON2_OFFSET               (0x8U)
#define BUFFER_MANAGE_WCH_MBLK_CON2_PPBUF1_START_ADDR_SHIFT (0U)
#define BUFFER_MANAGE_WCH_MBLK_CON2_PPBUF1_START_ADDR_MASK (0xFFFFFFFFU << BUFFER_MANAGE_WCH_MBLK_CON2_PPBUF1_START_ADDR_SHIFT) /* 0xFFFFFFFF */
/* WCH_MBLK_CON3 */
#define BUFFER_MANAGE_WCH_MBLK_CON3_OFFSET               (0xCU)
#define BUFFER_MANAGE_WCH_MBLK_CON3_PPBUF2_START_ADDR_SHIFT (0U)
#define BUFFER_MANAGE_WCH_MBLK_CON3_PPBUF2_START_ADDR_MASK (0xFFFFFFFFU << BUFFER_MANAGE_WCH_MBLK_CON3_PPBUF2_START_ADDR_SHIFT) /* 0xFFFFFFFF */
/* WCH_MBLK_CON4 */
#define BUFFER_MANAGE_WCH_MBLK_CON4_OFFSET               (0x10U)
#define BUFFER_MANAGE_WCH_MBLK_CON4_PPBUF3_START_ADDR_SHIFT (0U)
#define BUFFER_MANAGE_WCH_MBLK_CON4_PPBUF3_START_ADDR_MASK (0xFFFFFFFFU << BUFFER_MANAGE_WCH_MBLK_CON4_PPBUF3_START_ADDR_SHIFT) /* 0xFFFFFFFF */
/* WCH_MBLK_CON5 */
#define BUFFER_MANAGE_WCH_MBLK_CON5_OFFSET               (0x14U)
#define BUFFER_MANAGE_WCH_MBLK_CON5_PPBUF_OVERFLOW_MARGIN_SHIFT (0U)
#define BUFFER_MANAGE_WCH_MBLK_CON5_PPBUF_OVERFLOW_MARGIN_MASK (0x3FFU << BUFFER_MANAGE_WCH_MBLK_CON5_PPBUF_OVERFLOW_MARGIN_SHIFT) /* 0x000003FF */
#define BUFFER_MANAGE_WCH_MBLK_CON5_PPBUF_OVERFLOW_MODE_SHIFT (12U)
#define BUFFER_MANAGE_WCH_MBLK_CON5_PPBUF_OVERFLOW_MODE_MASK (0x1U << BUFFER_MANAGE_WCH_MBLK_CON5_PPBUF_OVERFLOW_MODE_SHIFT) /* 0x00001000 */
/* WCH_MBLK_CON6 */
#define BUFFER_MANAGE_WCH_MBLK_CON6_OFFSET               (0x18U)
#define BUFFER_MANAGE_WCH_MBLK_CON6_FRAME_DATA_NUM_SHIFT (0U)
#define BUFFER_MANAGE_WCH_MBLK_CON6_FRAME_DATA_NUM_MASK  (0x1FFFFFFU << BUFFER_MANAGE_WCH_MBLK_CON6_FRAME_DATA_NUM_SHIFT) /* 0x01FFFFFF */
#define BUFFER_MANAGE_WCH_MBLK_CON6_FRAME_PPBUF_SWITCH_MODE_SHIFT (28U)
#define BUFFER_MANAGE_WCH_MBLK_CON6_FRAME_PPBUF_SWITCH_MODE_MASK (0x1U << BUFFER_MANAGE_WCH_MBLK_CON6_FRAME_PPBUF_SWITCH_MODE_SHIFT) /* 0x10000000 */
#define BUFFER_MANAGE_WCH_MBLK_CON6_FRAME_END_MODE_SHIFT (29U)
#define BUFFER_MANAGE_WCH_MBLK_CON6_FRAME_END_MODE_MASK  (0x1U << BUFFER_MANAGE_WCH_MBLK_CON6_FRAME_END_MODE_SHIFT) /* 0x20000000 */
/* WCH_MBLK_STATUS0 */
#define BUFFER_MANAGE_WCH_MBLK_STATUS0_OFFSET            (0x20U)
#define BUFFER_MANAGE_WCH_MBLK_STATUS0_PPBUF_CUR_DCOUNTER_SHIFT (0U)
#define BUFFER_MANAGE_WCH_MBLK_STATUS0_PPBUF_CUR_DCOUNTER_MASK (0x1FFFFU << BUFFER_MANAGE_WCH_MBLK_STATUS0_PPBUF_CUR_DCOUNTER_SHIFT) /* 0x0001FFFF */
#define BUFFER_MANAGE_WCH_MBLK_STATUS0_PPBUF_CUR_INDEX_SHIFT (20U)
#define BUFFER_MANAGE_WCH_MBLK_STATUS0_PPBUF_CUR_INDEX_MASK (0x3U << BUFFER_MANAGE_WCH_MBLK_STATUS0_PPBUF_CUR_INDEX_SHIFT) /* 0x00300000 */
/* WCH_MBLK_STATUS1 */
#define BUFFER_MANAGE_WCH_MBLK_STATUS1_OFFSET            (0x24U)
#define BUFFER_MANAGE_WCH_MBLK_STATUS1_PPBUF_LAST_DCOUNTER_SHIFT (0U)
#define BUFFER_MANAGE_WCH_MBLK_STATUS1_PPBUF_LAST_DCOUNTER_MASK (0x1FFFFU << BUFFER_MANAGE_WCH_MBLK_STATUS1_PPBUF_LAST_DCOUNTER_SHIFT) /* 0x0001FFFF */
#define BUFFER_MANAGE_WCH_MBLK_STATUS1_PPBUF_LAST_INDEX_SHIFT (20U)
#define BUFFER_MANAGE_WCH_MBLK_STATUS1_PPBUF_LAST_INDEX_MASK (0x3U << BUFFER_MANAGE_WCH_MBLK_STATUS1_PPBUF_LAST_INDEX_SHIFT) /* 0x00300000 */
/* WCH_MBLK_STATUS2 */
#define BUFFER_MANAGE_WCH_MBLK_STATUS2_OFFSET            (0x28U)
#define BUFFER_MANAGE_WCH_MBLK_STATUS2_FRAM_CUR_COUNTER_SHIFT (0U)
#define BUFFER_MANAGE_WCH_MBLK_STATUS2_FRAM_CUR_COUNTER_MASK (0x1FFFFFFU << BUFFER_MANAGE_WCH_MBLK_STATUS2_FRAM_CUR_COUNTER_SHIFT) /* 0x01FFFFFF */
/* WCH_MBLK_STATUS3 */
#define BUFFER_MANAGE_WCH_MBLK_STATUS3_OFFSET            (0x2CU)
#define BUFFER_MANAGE_WCH_MBLK_STATUS3_FRAM_END_COUNTER_SHIFT (0U)
#define BUFFER_MANAGE_WCH_MBLK_STATUS3_FRAM_END_COUNTER_MASK (0x1FFFFFFU << BUFFER_MANAGE_WCH_MBLK_STATUS3_FRAM_END_COUNTER_SHIFT) /* 0x01FFFFFF */
/* WCH_MBLK_INT_EN */
#define BUFFER_MANAGE_WCH_MBLK_INT_EN_OFFSET             (0x30U)
#define BUFFER_MANAGE_WCH_MBLK_INT_EN_PPBUF0_FULL_INT_EN_SHIFT (0U)
#define BUFFER_MANAGE_WCH_MBLK_INT_EN_PPBUF0_FULL_INT_EN_MASK (0x1U << BUFFER_MANAGE_WCH_MBLK_INT_EN_PPBUF0_FULL_INT_EN_SHIFT) /* 0x00000001 */
#define BUFFER_MANAGE_WCH_MBLK_INT_EN_PPBUF1_FULL_INT_EN_SHIFT (1U)
#define BUFFER_MANAGE_WCH_MBLK_INT_EN_PPBUF1_FULL_INT_EN_MASK (0x1U << BUFFER_MANAGE_WCH_MBLK_INT_EN_PPBUF1_FULL_INT_EN_SHIFT) /* 0x00000002 */
#define BUFFER_MANAGE_WCH_MBLK_INT_EN_PPBUF2_FULL_INT_EN_SHIFT (2U)
#define BUFFER_MANAGE_WCH_MBLK_INT_EN_PPBUF2_FULL_INT_EN_MASK (0x1U << BUFFER_MANAGE_WCH_MBLK_INT_EN_PPBUF2_FULL_INT_EN_SHIFT) /* 0x00000004 */
#define BUFFER_MANAGE_WCH_MBLK_INT_EN_PPBUF3_FULL_INT_EN_SHIFT (3U)
#define BUFFER_MANAGE_WCH_MBLK_INT_EN_PPBUF3_FULL_INT_EN_MASK (0x1U << BUFFER_MANAGE_WCH_MBLK_INT_EN_PPBUF3_FULL_INT_EN_SHIFT) /* 0x00000008 */
#define BUFFER_MANAGE_WCH_MBLK_INT_EN_PPBUF_OVERFLOW_INT_EN_SHIFT (16U)
#define BUFFER_MANAGE_WCH_MBLK_INT_EN_PPBUF_OVERFLOW_INT_EN_MASK (0x1U << BUFFER_MANAGE_WCH_MBLK_INT_EN_PPBUF_OVERFLOW_INT_EN_SHIFT) /* 0x00010000 */
/* WCH_MBLK_INTSTS */
#define BUFFER_MANAGE_WCH_MBLK_INTSTS_OFFSET             (0x34U)
#define BUFFER_MANAGE_WCH_MBLK_INTSTS_PPBUF0_FULL_INTSTS_SHIFT (0U)
#define BUFFER_MANAGE_WCH_MBLK_INTSTS_PPBUF0_FULL_INTSTS_MASK (0x1U << BUFFER_MANAGE_WCH_MBLK_INTSTS_PPBUF0_FULL_INTSTS_SHIFT) /* 0x00000001 */
#define BUFFER_MANAGE_WCH_MBLK_INTSTS_PPBUF1_FULL_INTSTS_SHIFT (1U)
#define BUFFER_MANAGE_WCH_MBLK_INTSTS_PPBUF1_FULL_INTSTS_MASK (0x1U << BUFFER_MANAGE_WCH_MBLK_INTSTS_PPBUF1_FULL_INTSTS_SHIFT) /* 0x00000002 */
#define BUFFER_MANAGE_WCH_MBLK_INTSTS_PPBUF2_FULL_INTSTS_SHIFT (2U)
#define BUFFER_MANAGE_WCH_MBLK_INTSTS_PPBUF2_FULL_INTSTS_MASK (0x1U << BUFFER_MANAGE_WCH_MBLK_INTSTS_PPBUF2_FULL_INTSTS_SHIFT) /* 0x00000004 */
#define BUFFER_MANAGE_WCH_MBLK_INTSTS_PPBUF3_FULL_INTSTS_SHIFT (3U)
#define BUFFER_MANAGE_WCH_MBLK_INTSTS_PPBUF3_FULL_INTSTS_MASK (0x1U << BUFFER_MANAGE_WCH_MBLK_INTSTS_PPBUF3_FULL_INTSTS_SHIFT) /* 0x00000008 */
#define BUFFER_MANAGE_WCH_MBLK_INTSTS_PPBUF0_FULL_STATUS_SHIFT (4U)
#define BUFFER_MANAGE_WCH_MBLK_INTSTS_PPBUF0_FULL_STATUS_MASK (0x1U << BUFFER_MANAGE_WCH_MBLK_INTSTS_PPBUF0_FULL_STATUS_SHIFT) /* 0x00000010 */
#define BUFFER_MANAGE_WCH_MBLK_INTSTS_PPBUF1_FULL_STATUS_SHIFT (5U)
#define BUFFER_MANAGE_WCH_MBLK_INTSTS_PPBUF1_FULL_STATUS_MASK (0x1U << BUFFER_MANAGE_WCH_MBLK_INTSTS_PPBUF1_FULL_STATUS_SHIFT) /* 0x00000020 */
#define BUFFER_MANAGE_WCH_MBLK_INTSTS_PPBUF2_FULL_STATUS_SHIFT (6U)
#define BUFFER_MANAGE_WCH_MBLK_INTSTS_PPBUF2_FULL_STATUS_MASK (0x1U << BUFFER_MANAGE_WCH_MBLK_INTSTS_PPBUF2_FULL_STATUS_SHIFT) /* 0x00000040 */
#define BUFFER_MANAGE_WCH_MBLK_INTSTS_PPBUF3_FULL_STATUS_SHIFT (7U)
#define BUFFER_MANAGE_WCH_MBLK_INTSTS_PPBUF3_FULL_STATUS_MASK (0x1U << BUFFER_MANAGE_WCH_MBLK_INTSTS_PPBUF3_FULL_STATUS_SHIFT) /* 0x00000080 */
#define BUFFER_MANAGE_WCH_MBLK_INTSTS_PPBUF0_FIRST_FLAG_STATUS_SHIFT (8U)
#define BUFFER_MANAGE_WCH_MBLK_INTSTS_PPBUF0_FIRST_FLAG_STATUS_MASK (0x1U << BUFFER_MANAGE_WCH_MBLK_INTSTS_PPBUF0_FIRST_FLAG_STATUS_SHIFT) /* 0x00000100 */
#define BUFFER_MANAGE_WCH_MBLK_INTSTS_PPBUF1_FIRST_FLAG_STATUS_SHIFT (9U)
#define BUFFER_MANAGE_WCH_MBLK_INTSTS_PPBUF1_FIRST_FLAG_STATUS_MASK (0x1U << BUFFER_MANAGE_WCH_MBLK_INTSTS_PPBUF1_FIRST_FLAG_STATUS_SHIFT) /* 0x00000200 */
#define BUFFER_MANAGE_WCH_MBLK_INTSTS_PPBUF2_FIRST_FLAG_STATUS_SHIFT (10U)
#define BUFFER_MANAGE_WCH_MBLK_INTSTS_PPBUF2_FIRST_FLAG_STATUS_MASK (0x1U << BUFFER_MANAGE_WCH_MBLK_INTSTS_PPBUF2_FIRST_FLAG_STATUS_SHIFT) /* 0x00000400 */
#define BUFFER_MANAGE_WCH_MBLK_INTSTS_PPBUF3_FIRST_FLAG_STATUS_SHIFT (11U)
#define BUFFER_MANAGE_WCH_MBLK_INTSTS_PPBUF3_FIRST_FLAG_STATUS_MASK (0x1U << BUFFER_MANAGE_WCH_MBLK_INTSTS_PPBUF3_FIRST_FLAG_STATUS_SHIFT) /* 0x00000800 */
#define BUFFER_MANAGE_WCH_MBLK_INTSTS_PPBUF0_LAST_FLAG_STATUS_SHIFT (12U)
#define BUFFER_MANAGE_WCH_MBLK_INTSTS_PPBUF0_LAST_FLAG_STATUS_MASK (0x1U << BUFFER_MANAGE_WCH_MBLK_INTSTS_PPBUF0_LAST_FLAG_STATUS_SHIFT) /* 0x00001000 */
#define BUFFER_MANAGE_WCH_MBLK_INTSTS_PPBUF1_LAST_FLAG_STATUS_SHIFT (13U)
#define BUFFER_MANAGE_WCH_MBLK_INTSTS_PPBUF1_LAST_FLAG_STATUS_MASK (0x1U << BUFFER_MANAGE_WCH_MBLK_INTSTS_PPBUF1_LAST_FLAG_STATUS_SHIFT) /* 0x00002000 */
#define BUFFER_MANAGE_WCH_MBLK_INTSTS_PPBUF2_LAST_FLAG_STATUS_SHIFT (14U)
#define BUFFER_MANAGE_WCH_MBLK_INTSTS_PPBUF2_LAST_FLAG_STATUS_MASK (0x1U << BUFFER_MANAGE_WCH_MBLK_INTSTS_PPBUF2_LAST_FLAG_STATUS_SHIFT) /* 0x00004000 */
#define BUFFER_MANAGE_WCH_MBLK_INTSTS_PPBUF3_LAST_FLAG_STATUS_SHIFT (15U)
#define BUFFER_MANAGE_WCH_MBLK_INTSTS_PPBUF3_LAST_FLAG_STATUS_MASK (0x1U << BUFFER_MANAGE_WCH_MBLK_INTSTS_PPBUF3_LAST_FLAG_STATUS_SHIFT) /* 0x00008000 */
#define BUFFER_MANAGE_WCH_MBLK_INTSTS_PPBUF_OVERFLOW_INTSTS_SHIFT (16U)
#define BUFFER_MANAGE_WCH_MBLK_INTSTS_PPBUF_OVERFLOW_INTSTS_MASK (0x1U << BUFFER_MANAGE_WCH_MBLK_INTSTS_PPBUF_OVERFLOW_INTSTS_SHIFT) /* 0x00010000 */
/* RCH_MBLK_CON0 */
#define BUFFER_MANAGE_RCH_MBLK_CON0_OFFSET               (0x200U)
#define BUFFER_MANAGE_RCH_MBLK_CON0_PPBUF_ENABLE_SHIFT   (0U)
#define BUFFER_MANAGE_RCH_MBLK_CON0_PPBUF_ENABLE_MASK    (0x1U << BUFFER_MANAGE_RCH_MBLK_CON0_PPBUF_ENABLE_SHIFT)   /* 0x00000001 */
#define BUFFER_MANAGE_RCH_MBLK_CON0_PPBUF0_EMPTY_HARDCLR_EN_SHIFT (1U)
#define BUFFER_MANAGE_RCH_MBLK_CON0_PPBUF0_EMPTY_HARDCLR_EN_MASK (0x1U << BUFFER_MANAGE_RCH_MBLK_CON0_PPBUF0_EMPTY_HARDCLR_EN_SHIFT) /* 0x00000002 */
#define BUFFER_MANAGE_RCH_MBLK_CON0_PPBUF1_EMPTY_HARDCLR_EN_SHIFT (2U)
#define BUFFER_MANAGE_RCH_MBLK_CON0_PPBUF1_EMPTY_HARDCLR_EN_MASK (0x1U << BUFFER_MANAGE_RCH_MBLK_CON0_PPBUF1_EMPTY_HARDCLR_EN_SHIFT) /* 0x00000004 */
#define BUFFER_MANAGE_RCH_MBLK_CON0_PPBUF_SIZE_SHIFT     (4U)
#define BUFFER_MANAGE_RCH_MBLK_CON0_PPBUF_SIZE_MASK      (0x1FFFFU << BUFFER_MANAGE_RCH_MBLK_CON0_PPBUF_SIZE_SHIFT) /* 0x001FFFF0 */
#define BUFFER_MANAGE_RCH_MBLK_CON0_ADDR_HIGHBIT_SHIFT   (28U)
#define BUFFER_MANAGE_RCH_MBLK_CON0_ADDR_HIGHBIT_MASK    (0xFU << BUFFER_MANAGE_RCH_MBLK_CON0_ADDR_HIGHBIT_SHIFT)   /* 0xF0000000 */
/* RCH_MBLK_CON1 */
#define BUFFER_MANAGE_RCH_MBLK_CON1_OFFSET               (0x204U)
#define BUFFER_MANAGE_RCH_MBLK_CON1_PPBUF0_START_ADDR_SHIFT (0U)
#define BUFFER_MANAGE_RCH_MBLK_CON1_PPBUF0_START_ADDR_MASK (0xFFFFFFFFU << BUFFER_MANAGE_RCH_MBLK_CON1_PPBUF0_START_ADDR_SHIFT) /* 0xFFFFFFFF */
/* RCH_MBLK_CON2 */
#define BUFFER_MANAGE_RCH_MBLK_CON2_OFFSET               (0x208U)
#define BUFFER_MANAGE_RCH_MBLK_CON2_PPBUF1_START_ADDR_SHIFT (0U)
#define BUFFER_MANAGE_RCH_MBLK_CON2_PPBUF1_START_ADDR_MASK (0xFFFFFFFFU << BUFFER_MANAGE_RCH_MBLK_CON2_PPBUF1_START_ADDR_SHIFT) /* 0xFFFFFFFF */
/* RCH_MBLK_CON6 */
#define BUFFER_MANAGE_RCH_MBLK_CON6_OFFSET               (0x218U)
#define BUFFER_MANAGE_RCH_MBLK_CON6_FRAME_DATA_NUM_SHIFT (0U)
#define BUFFER_MANAGE_RCH_MBLK_CON6_FRAME_DATA_NUM_MASK  (0x1FFFFFFU << BUFFER_MANAGE_RCH_MBLK_CON6_FRAME_DATA_NUM_SHIFT) /* 0x01FFFFFF */
#define BUFFER_MANAGE_RCH_MBLK_CON6_FRAME_PPBUF_SWITCH_MODE_SHIFT (28U)
#define BUFFER_MANAGE_RCH_MBLK_CON6_FRAME_PPBUF_SWITCH_MODE_MASK (0x1U << BUFFER_MANAGE_RCH_MBLK_CON6_FRAME_PPBUF_SWITCH_MODE_SHIFT) /* 0x10000000 */
#define BUFFER_MANAGE_RCH_MBLK_CON6_FRAME_END_MODE_SHIFT (29U)
#define BUFFER_MANAGE_RCH_MBLK_CON6_FRAME_END_MODE_MASK  (0x1U << BUFFER_MANAGE_RCH_MBLK_CON6_FRAME_END_MODE_SHIFT) /* 0x20000000 */
/* RCH_MBLK_STATUS0 */
#define BUFFER_MANAGE_RCH_MBLK_STATUS0_OFFSET            (0x220U)
#define BUFFER_MANAGE_RCH_MBLK_STATUS0_PPBUF_CUR_DCOUNTER_SHIFT (0U)
#define BUFFER_MANAGE_RCH_MBLK_STATUS0_PPBUF_CUR_DCOUNTER_MASK (0x1FFFFU << BUFFER_MANAGE_RCH_MBLK_STATUS0_PPBUF_CUR_DCOUNTER_SHIFT) /* 0x0001FFFF */
#define BUFFER_MANAGE_RCH_MBLK_STATUS0_PPBUF_CUR_INDEX_SHIFT (20U)
#define BUFFER_MANAGE_RCH_MBLK_STATUS0_PPBUF_CUR_INDEX_MASK (0x1U << BUFFER_MANAGE_RCH_MBLK_STATUS0_PPBUF_CUR_INDEX_SHIFT) /* 0x00100000 */
/* RCH_MBLK_STATUS2 */
#define BUFFER_MANAGE_RCH_MBLK_STATUS2_OFFSET            (0x228U)
#define BUFFER_MANAGE_RCH_MBLK_STATUS2_FRAM_CUR_DCOUNTER_SHIFT (4U)
#define BUFFER_MANAGE_RCH_MBLK_STATUS2_FRAM_CUR_DCOUNTER_MASK (0x1FFFFU << BUFFER_MANAGE_RCH_MBLK_STATUS2_FRAM_CUR_DCOUNTER_SHIFT) /* 0x001FFFF0 */
/* RCH_MBLK_STATUS3 */
#define BUFFER_MANAGE_RCH_MBLK_STATUS3_OFFSET            (0x22CU)
#define BUFFER_MANAGE_RCH_MBLK_STATUS3_FRAM_END_DCOUNTER_SHIFT (4U)
#define BUFFER_MANAGE_RCH_MBLK_STATUS3_FRAM_END_DCOUNTER_MASK (0x1FFFFU << BUFFER_MANAGE_RCH_MBLK_STATUS3_FRAM_END_DCOUNTER_SHIFT) /* 0x001FFFF0 */
/* RCH_MBLK_INT_EN */
#define BUFFER_MANAGE_RCH_MBLK_INT_EN_OFFSET             (0x230U)
#define BUFFER_MANAGE_RCH_MBLK_INT_EN_PPBUF0_EMPTY_INT_EN_SHIFT (0U)
#define BUFFER_MANAGE_RCH_MBLK_INT_EN_PPBUF0_EMPTY_INT_EN_MASK (0x1U << BUFFER_MANAGE_RCH_MBLK_INT_EN_PPBUF0_EMPTY_INT_EN_SHIFT) /* 0x00000001 */
#define BUFFER_MANAGE_RCH_MBLK_INT_EN_PPBUF1_EMPTY_INT_EN_SHIFT (1U)
#define BUFFER_MANAGE_RCH_MBLK_INT_EN_PPBUF1_EMPTY_INT_EN_MASK (0x1U << BUFFER_MANAGE_RCH_MBLK_INT_EN_PPBUF1_EMPTY_INT_EN_SHIFT) /* 0x00000002 */
/* RCH_MBLK_INTSTS */
#define BUFFER_MANAGE_RCH_MBLK_INTSTS_OFFSET             (0x234U)
#define BUFFER_MANAGE_RCH_MBLK_INTSTS_PPBUF0_EMPTY_INTSTS_SHIFT (0U)
#define BUFFER_MANAGE_RCH_MBLK_INTSTS_PPBUF0_EMPTY_INTSTS_MASK (0x1U << BUFFER_MANAGE_RCH_MBLK_INTSTS_PPBUF0_EMPTY_INTSTS_SHIFT) /* 0x00000001 */
#define BUFFER_MANAGE_RCH_MBLK_INTSTS_PPBUF1_EMPTY_INTSTS_SHIFT (1U)
#define BUFFER_MANAGE_RCH_MBLK_INTSTS_PPBUF1_EMPTY_INTSTS_MASK (0x1U << BUFFER_MANAGE_RCH_MBLK_INTSTS_PPBUF1_EMPTY_INTSTS_SHIFT) /* 0x00000002 */
#define BUFFER_MANAGE_RCH_MBLK_INTSTS_PPBUF0_EMPTY_STATUS_SHIFT (4U)
#define BUFFER_MANAGE_RCH_MBLK_INTSTS_PPBUF0_EMPTY_STATUS_MASK (0x1U << BUFFER_MANAGE_RCH_MBLK_INTSTS_PPBUF0_EMPTY_STATUS_SHIFT) /* 0x00000010 */
#define BUFFER_MANAGE_RCH_MBLK_INTSTS_PPBUF1_EMPTY_STATUS_SHIFT (5U)
#define BUFFER_MANAGE_RCH_MBLK_INTSTS_PPBUF1_EMPTY_STATUS_MASK (0x1U << BUFFER_MANAGE_RCH_MBLK_INTSTS_PPBUF1_EMPTY_STATUS_SHIFT) /* 0x00000020 */
/******************************************WDT*******************************************/
/* CR */
