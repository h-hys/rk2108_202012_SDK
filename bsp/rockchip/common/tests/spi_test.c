...
static void spi_test_show_usage()
{
    ...
    rt_kprintf("2. spi_test read   <spi_device> <times> <size>\n");
    rt_kprintf("3. spi_test write  <spi_device> <times> <size>\n");
    rt_kprintf("4. spi_test loop   <spi_device> <times> <size>\n");
