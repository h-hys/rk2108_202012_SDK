...
static void usb_pcd_lowlevel_hw_init(struct PCD_HANDLE *pcd)
{
    ...
    HAL_PCDEx_SetTxFiFo(pcd, 0, 0x10);
    HAL_PCDEx_SetTxFiFo(pcd, 1, 0x100);
    HAL_PCDEx_SetTxFiFo(pcd, 3, 0x100);
    HAL_PCDEx_SetTxFiFo(pcd, 5, 0x100);
    HAL_PCDEx_SetTxFiFo(pcd, 7, 0x10);
    HAL_PCDEx_SetTxFiFo(pcd, 8, 0x10);
    HAL_PCDEx_SetTxFiFo(pcd, 9, 0x10);
#endif
