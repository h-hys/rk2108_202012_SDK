...
struct rk_isp_vcm_tim
{
    rt_tick_t vcm_start_t; //???  rt_tick_t ???
    rt_tick_t vcm_end_t;
};

struct rk_isp_subdev_stat
{
    struct rk_isp_lightsensor_stat ls;
    struct rk_isp_vcm_tim vcm;
};
...
struct rk_isp_lsc_config
{
    ...
    unsigned int x_grad_tbl[RK_ISP_LSC_GRAD_TBL_SIZE];
    unsigned int y_grad_tbl[RK_ISP_LSC_GRAD_TBL_SIZE];

    unsigned int x_size_tbl[RK_ISP_LSC_SIZE_TBL_SIZE];
    unsigned int y_size_tbl[RK_ISP_LSC_SIZE_TBL_SIZE];
