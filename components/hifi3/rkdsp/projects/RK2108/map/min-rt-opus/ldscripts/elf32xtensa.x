/* This linker script generated from xt-genldscripts.tpp for LSP min-rt-opus */
/* Linker Script for default link */
MEMORY
{
  sram1_seg :                         	org = 0x200C0000, len = 0x40000
  ...
  srom0_seg :                         	org = 0x60200000, len = 0x100000
}
...
_memmap_seg_sram1_start = 0x200c0000;
...
_memmap_seg_srom0_max   = 0x60300000;
...
SECTIONS
{
  ...
  PROVIDE(__stack = 0x30280000);
  _heap_sentry = 0x30280000;
