/* This linker script generated from xt-genldscripts.tpp for LSP min-rt-opus-xip */
...
MEMORY
{
  ...
  srom0_seg :                         	org = 0x607C0000, len = 0x40000
}
...
_memmap_mem_srom_end   = 0x60800000;
...
_memmap_seg_srom0_start = 0x607c0000;
_memmap_seg_srom0_max   = 0x60800000;

_rom_store_table = 0;
PROVIDE(_memmap_vecbase_reset = 0x30000400);
PROVIDE(_memmap_reset_vector = 0x30000000);
/* Various memory-map dependent cache attribute settings: */
_memmap_cacheattr_wb_base = 0x00001040;
_memmap_cacheattr_wt_base = 0x00003040;
_memmap_cacheattr_bp_base = 0x00004040;
_memmap_cacheattr_unused_mask = 0xFFFF0F0F;
...
_memmap_cacheattr_wb_strict = 0x00001040;
_memmap_cacheattr_wt_strict = 0x00003040;
_memmap_cacheattr_bp_strict = 0x00004040;
...
SECTIONS
{
  ...
  .dram0.info.data : ALIGN(4)
  {
    _dram0_info_data_start = ABSOLUTE(.);
    *(.dram0.info.data)
    . = ALIGN (4);
    _dram0_info_data_end = ABSOLUTE(.);
  ...
  .srom.info.rodata : ALIGN(4)
  {
    _srom_info_rodata_start = ABSOLUTE(.);
    *(.srom.info.rodata)
    . = ALIGN (4);
    _srom_info_rodata_end = ABSOLUTE(.);
