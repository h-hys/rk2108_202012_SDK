/* This linker script generated from xt-genldscripts.tpp for LSP min-rt-vad-kws */
...
MEMORY
{
  ...
  dram0_0_seg :                       	org = 0x30200400, len = 0x2FC00
}
...
_memmap_mem_dram0_end   = 0x30260000;
...
SECTIONS
{
  ...
  PROVIDE(__stack = 0x30230000);
  _end = 0x30230000;
  PROVIDE(end = 0x30230000);
