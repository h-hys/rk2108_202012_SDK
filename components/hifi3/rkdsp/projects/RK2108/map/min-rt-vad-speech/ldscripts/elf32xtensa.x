/* This linker script generated from xt-genldscripts.tpp for LSP min-rt-vad-speech */
/* Linker Script for default link */
MEMORY
{
  sram1_seg :                         	org = 0x200E0000, len = 0x20000
  iram0_0_seg :                       	org = 0x30000000, len = 0x400
  ...
  dram0_0_seg :                       	org = 0x30200400, len = 0x1FC00
  srom0_seg :                         	org = 0x60200000, len = 0x80001
}
...
_memmap_mem_sram_end   = 0x20100000;
_memmap_mem_iram0_start = 0x30000000;
_memmap_mem_iram0_end   = 0x30010000;
_memmap_mem_dram0_start = 0x30200000;
_memmap_mem_dram0_end   = 0x30280000;
_memmap_mem_srom_start = 0x60000000;
_memmap_mem_srom_end   = 0xa0000000;

/*  Memory segment boundary addresses:  */
_memmap_seg_sram1_start = 0x200e0000;
_memmap_seg_sram1_max   = 0x20100000;
_memmap_seg_iram0_0_start = 0x30000000;
_memmap_seg_iram0_0_max   = 0x30000400;
...
_memmap_seg_dram0_0_start = 0x30200400;
_memmap_seg_dram0_0_max   = 0x30220000;
_memmap_seg_srom0_start = 0x60200000;
_memmap_seg_srom0_max   = 0x60280001;

_rom_store_table = 0;
PROVIDE(_memmap_vecbase_reset = 0x30000400);
PROVIDE(_memmap_reset_vector = 0x30000000);
/* Various memory-map dependent cache attribute settings: */
_memmap_cacheattr_wb_base = 0x00011010;
_memmap_cacheattr_wt_base = 0x00033030;
_memmap_cacheattr_bp_base = 0x00044040;
_memmap_cacheattr_unused_mask = 0xFFF00F0F;
_memmap_cacheattr_wb_trapnull = 0x44411410;
_memmap_cacheattr_wba_trapnull = 0x44411410;
_memmap_cacheattr_wbna_trapnull = 0x44422420;
_memmap_cacheattr_wt_trapnull = 0x44433430;
_memmap_cacheattr_bp_trapnull = 0x44444440;
_memmap_cacheattr_wb_strict = 0x00011010;
_memmap_cacheattr_wt_strict = 0x00033030;
_memmap_cacheattr_bp_strict = 0x00044040;
_memmap_cacheattr_wb_allvalid = 0x44411414;
_memmap_cacheattr_wt_allvalid = 0x44433434;
...
SECTIONS
{
  ...
  PROVIDE(__stack = 0x30220000);
  _end = 0x30220000;
  PROVIDE(end = 0x30220000);
  _heap_sentry = 0x30260000;
