/* This linker script generated from xt-genldscripts.tpp for LSP vectorSel-RK2206 */
/* Linker Script for default link */
MEMORY
{
  sram0_seg :                         	org = 0x20034000, len = 0x400
  sram1_seg :                         	org = 0x20034400, len = 0x1C00
  ...
  dram0_0_seg :                       	org = 0x30200000, len = 0x30000
}
...
_memmap_mem_sram_start = 0x20030000;
...
_memmap_seg_sram0_start = 0x20034000;
_memmap_seg_sram0_max   = 0x20034400;
_memmap_seg_sram1_start = 0x20034400;
_memmap_seg_sram1_max   = 0x20036000;
...
_memmap_seg_dram0_0_max   = 0x30230000;

_rom_store_table = 0;
PROVIDE(_memmap_vecbase_reset = 0x30000400);
PROVIDE(_memmap_reset_vector = 0x20034000);
...
SECTIONS
{
  ...
  PROVIDE(__stack = 0x20036000);
  _heap_sentry = 0x20036000;
