/* This linker script generated from xt-genldscripts.tpp for LSP modelTest-RK2206 */
...
MEMORY
{
  ...
  iram0_5_seg :                       	org = 0x300005DC, len = 0x5A24
  dram0_0_seg :                       	org = 0x30200000, len = 0x2000
}
...
_memmap_seg_iram0_5_max   = 0x30006000;
_memmap_seg_dram0_0_start = 0x30200000;
_memmap_seg_dram0_0_max   = 0x30202000;
...
SECTIONS
{
  ...
  PROVIDE(__stack = 0x30202000);
  _heap_sentry = 0x30202000;
  .debug  0 :  { *(.debug) }
  .line  0 :  { *(.line) }
